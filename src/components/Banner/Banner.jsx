...
const Banner = () => {
    return (
        <div className='w-9/12 mx-auto py-5 lg:py-20 flex flex-col-reverse md:flex-row justify-between  items-center gap-10'>
            <div className='space-y-3'>
                ...
                <div className='flex justify-start items-center gap-3'>
                    <button className='btn btn-primary border-none bg-linear-to-r from-[#4F39F6] to-[#9514FA] py-2 px-4 rounded-full'>Explore Products</button>
                    <button className='flex justify-between items-center gap-2 border-blue-600 bg-white btn hover:border-none hover:bg-linear-to-r hover:from-[#4F39F6] hover:to-[#9514FA] hover:text-white py-2 px-4 rounded-full'><CiPlay1 /> Watch Demo</button>
                </div>
            </div>
            <div>
