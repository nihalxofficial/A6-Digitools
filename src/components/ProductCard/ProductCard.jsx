...
const ProductCard = ({product}) => {
    return (
        <div className='flex flex-col shadow-sm rounded-2xl p-5 relative'>
            ...
            <div className={`absolute rounded-full px-3 py-1 top-2 right-2 text-sm
                 ${product.tagType === "best seller"? "text-orange-600 bg-[#FEF3C6]"
                    : product.tagType === "popular"? "text-purple-600 bg-[#E1E7FF]"
